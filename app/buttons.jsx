  ...
  return (
    <GestureHandlerRootView style={styles.container}>  
      <SafeAreaView className="bg-primary h-full">
        ...
        <TouchableOpacity style={[styles.buttons, { borderRadius: 32.5, height: 64, marginTop: 20 }]} onPress={() => console.log('Turbidity Button 1 Pressed')}>
            <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white' }}>
            Clean
            </Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.buttons, { borderRadius: 32.5, height: 64, marginTop: 10 }]} onPress={() => console.log('Turbidity Button 2 Pressed')}>
            <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white' }}>
            Murky
            </Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.buttons, { borderRadius: 32.5, height: 64, marginTop: 10 }]} onPress={() => console.log('Turbidity Button 3 Pressed')}>
            <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white' }}>
            Dark
            </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={[styles.buttons, { borderRadius: 32.5, height: 64, marginTop: 20 }]} onPress={() => console.log('pH Button 1 Pressed')}>
            <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'red' }}>
            0.0
            </Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.buttons, { borderRadius: 32.5, height: 64, marginTop: 10 }]} onPress={() => console.log('pH Button 2 Pressed')}>
            <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white' }}>
            4.0
            </Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.buttons, { borderRadius: 32.5, height: 64, marginTop: 10 }]} onPress={() => console.log('pH Button 3 Pressed')}>
            <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white' }}>
            7.0
            </Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.buttons, { borderRadius: 32.5, height: 64, marginTop: 10 }]} onPress={() => console.log('pH Button 4 Pressed')}>
            <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white' }}>
            10.0
            </Text>
        </TouchableOpacity>
